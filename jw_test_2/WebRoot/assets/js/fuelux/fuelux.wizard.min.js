...
(function(c, d) {
    ...
    var b = function(g, f) {
        ...
        if (this.currentStep > 1) { this.selectedItem(this.options.selectedItem) }
    ...
    b.prototype = {
        ...
        setState: function() {
            ...
            if (!this.options.disablePreviousStep) { this.$prevBtn.attr("disabled", (p === true || o === false)) }
        ...
        stepclicked: function(j) {
            ...
            var f = true;
            if (this.options.disablePreviousStep) { if (i < this.currentStep) { f = false } }
            if (f) {
        ...
        previous: function() {
            ...
            if (this.options.disablePreviousStep) { f = false }
            if (f) {
        ...
        next: function() {
            ...
            if (h) {
                ...
                this.currentStep += 1;
                this.setState()
            } else { if (f) { this.$element.trigger("finished") } }
        },
        selectedItem: function(f) {
            ...
            if (f) {
                ...
                g = this
            } else { g = { step: this.currentStep } }
            return g
        }
    };
    c.fn.wizard = function(g) { var f = Array.prototype.slice.call(arguments, 1); var h; var e = this.each(function() { var k = c(this); var j = k.data("wizard"); var i = typeof g === "object" && g; if (!j) { k.data("wizard", (j = new b(this, i))) } if (typeof g === "string") { h = j[g].apply(j, f) } }); return (h === d) ? e : h };
    c.fn.wizard.defaults = { selectedItem: { step: 1 } };
    c.fn.wizard.Constructor = b;
    c.fn.wizard.noConflict = function() { c.fn.wizard = a; return this };
    c(function() {
        c("body").on("mouseover.wizard.data-api", ".wizard", function() {
            var e = c(this);
            if (e.data("wizard")) { return }
            e.wizard(e.data())
        })
    })
})(window.jQuery);