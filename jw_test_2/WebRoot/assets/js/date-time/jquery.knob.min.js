    ...
    b.o = function() {
        ...
        this.run = function() {
            ...
            if (this.$.is("fieldset")) {
                ...
                this.$.bind("change blur", function() { e.val(e._validate(e.o.parse(e.$.val()))) })
        ...
        this.copy = function(j, h) { for (var g in j) { h[g] = j[g] } }
    };
    b.Dial = function() {
        b.o.call(this);
        ...
        this.w2 = null;
        this.PI2 = 2 * Math.PI;
        this.extend = function() { this.o = d.extend({ bgColor: this.$.data("bgcolor") || "#EEEEEE", angleOffset: this.$.data("angleoffset") || 0, angleArc: this.$.data("anglearc") || 360, inline: true }, this.o) };
        this.val = function(e, f) {
            if (null != e) {
                e = this.o.parse(e);
                if (f !== false && (e != this.v) && this.rH && (this.rH(e) === false)) { return }
        ...
        this.xy2val = function(e, h) {
            ...
            if (this.o.flip) { f = this.angleArc - f - this.PI2 }
            if (this.angleArc != this.PI2 && (f < 0) && (f > -0.5)) { f = 0 } else { if (f < 0) { f += this.PI2 } }
        ...
        this.listen = function() {
            var h = this,
                ...
                j, k, e = 1,
                i = { 37: -h.o.step, 38: h.o.step, 39: h.o.step, 40: -h.o.step };
            this.$.bind("keydown", function(o) {
                var n = o.keyCode;
                if (n >= 96 && n <= 105) { n = o.keyCode = n - 48 }
                ...
                if (isNaN(j)) {
                    ...
                    if (d.inArray(n, [37, 38, 39, 40]) > -1) {
                        ...
                        h.change(m);
                        h._draw();
                        k = window.setTimeout(function() { e *= 2 }, 30)
                    }
                }
